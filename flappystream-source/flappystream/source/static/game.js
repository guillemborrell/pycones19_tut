...
sprite.src = "/static/img/sprite.png";

// LOAD SOUNDS
const SCORE_S = new Audio();
SCORE_S.src = "/static/audio/sfx_point.wav";

const FLAP = new Audio();
FLAP.src = "/static/audio/sfx_flap.wav";

const HIT = new Audio();
HIT.src = "/static/audio/sfx_hit.wav";

const SWOOSHING = new Audio();
SWOOSHING.src = "/static/audio/sfx_swooshing.wav";

const DIE = new Audio();
DIE.src = "/static/audio/sfx_die.wav";
